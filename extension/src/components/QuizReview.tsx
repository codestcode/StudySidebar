  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900">
      <header className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
        ...
        <h2 className="text-base font-semibold text-slate-900 dark:text-white font-nunito">Answer Review</h2>
            ...
            >
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-slate-900 dark:text-white font-nunito mb-1">Question {detail.questionIndex}</p>
                  <p className="text-sm text-slate-700 dark:text-slate-300 mb-3 font-nunito">{detail.question}</p>
                  <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs">
                    <span className="text-slate-500 dark:text-slate-400 font-nunito">
                      Your answer:{' '}
